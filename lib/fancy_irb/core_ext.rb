...
FancyIrb.register_height_trackers $stdin.singleton_class, FancyIrb::TRACK_HEIGHT_INPUT_METHODS

# patch some ARGF methods to track height
FancyIrb.register_height_trackers $<.singleton_class, FancyIrb::TRACK_HEIGHT_INPUT_METHODS
